...
//to the toast messages container. Create the HTML element for a new toast message
//with `document.createElement()`. Have a look at the `index.html` to see
//the required HTML tag and class name.
